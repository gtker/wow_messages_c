...
int main(void) {
    ...
    do {
        ...
        WowLoginReader reader = wlm_create_reader(buffer, sizeof(buffer));

        AllClientOpcodeContainer opcode;
        WowLoginResult result = all_client_opcode_read(&reader, &opcode);
        ...
        /* C89 scope to allow variable declarations */ {
            WowLoginWriter writer = wlm_create_writer(write_buffer, sizeof(write_buffer));
            result = all_CMD_AUTH_LOGON_CHALLENGE_Client_write(&writer, &opcode.body.CMD_AUTH_LOGON_CHALLENGE_Client);

            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_CHALLENGE_Client 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_RECONNECT_CHALLENGE_Client 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_RECONNECT_CHALLENGE_Client 1");
        }
    }while (0);
    ...
    do {
        ...
        WowLoginResult result = version2_server_opcode_read(&reader, &opcode);
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_CHALLENGE_Server 0");
        }
    }while (0);
    ...
    do {
        ...
        WowLoginResult result = version2_client_opcode_read(&reader, &opcode);
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_PROOF_Client 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_PROOF_Client 1");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_PROOF_Client 2");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_PROOF_Server 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_RECONNECT_CHALLENGE_Server 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_RECONNECT_CHALLENGE_Server 1");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_RECONNECT_PROOF_Server 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_RECONNECT_PROOF_Server 1");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_RECONNECT_PROOF_Server 2");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_RECONNECT_PROOF_Client 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_REALM_LIST_Server 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_REALM_LIST_Server 1");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_REALM_LIST_Client 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_XFER_INITIATE 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_XFER_DATA 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_XFER_ACCEPT 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_XFER_RESUME 0");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_XFER_CANCEL 0");
        }
    }while (0);
    ...
    do {
        ...
        WowLoginResult result = version3_server_opcode_read(&reader, &opcode);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_CHALLENGE_Server 1");
        }
    }while (0);
    ...
    do {
        ...
        WowLoginResult result = version3_client_opcode_read(&reader, &opcode);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_PROOF_Client 3");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_SURVEY_RESULT 0");
        }
    }while (0);
    ...
    do {
        ...
        WowLoginResult result = version5_server_opcode_read(&reader, &opcode);
    ...
    do {
        ...
        WowLoginResult result = version5_client_opcode_read(&reader, &opcode);
    ...
    do {
        ...
        WowLoginResult result = version6_server_opcode_read(&reader, &opcode);
    ...
    do {
        ...
        WowLoginResult result = version8_server_opcode_read(&reader, &opcode);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_CHALLENGE_Server 2");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_CHALLENGE_Server 3");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_CHALLENGE_Server 4");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_CHALLENGE_Server 5");
        }
    }while (0);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_CHALLENGE_Server 6");
        }
    }while (0);
    ...
    do {
        ...
        WowLoginResult result = version8_client_opcode_read(&reader, &opcode);
    ...
    do {
        ...
        /* C89 scope to allow variable declarations */ {
            ...
            wlm_test_compare_buffers(buffer, write_buffer, sizeof(write_buffer), __FILE__ ":" STRINGIFY(__LINE__) " CMD_AUTH_LOGON_PROOF_Server 1");
        }
    }while (0);
