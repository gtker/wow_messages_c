...
/* ItemClassAndSubClass SKIPPED BECAUSE OF INTEGER SIZE */
...
typedef enum {
    ...
    VANILLA_ATTRIBUTES_NO_AURA_CANCEL = -2147483648,
} vanilla_Attributes;
...
typedef enum {
    ...
    VANILLA_ATTRIBUTES_EX1_CAST_WHEN_LEARNED = -2147483648,
...
typedef enum {
    ...
    VANILLA_ATTRIBUTES_EX2_RETAIN_ITEM_CAST = -2147483648,
...
typedef enum {
    ...
    VANILLA_ATTRIBUTES_EX3_NOT_ON_AOE_IMMUNE = -2147483648,
...
typedef enum {
    ...
    VANILLA_SPLINE_FLAG_UNKNOWN31 = -2147483648,
} vanilla_SplineFlag;
...
typedef struct {
    ...
    vanilla_CharacterGear* equipment;
...
typedef struct {
    ...
    vanilla_QuestItemReward* rewards;
    vanilla_QuestItemReward* choice_rewards;
    ...
    vanilla_QuestObjective* objectives;
    WowWorldString* objective_texts;
...
typedef struct {
    ...
    vanilla_RaidTargetUpdate* raid_targets;
...
typedef struct {
    uint32_t survey_id;
    vanilla_GmSurveyQuestion* questions;
