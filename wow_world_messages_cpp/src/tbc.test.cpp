...
int main() {
    /* CMSG_TELEPORT_TO_UNIT */ {
        ...
        const auto opcode = ::wow_world_messages::tbc::read_client_opcode(reader);
        if (opcode.is_none()) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_TELEPORT_TO_UNIT 0 read invalid opcode");
            abort();
        }

        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_TELEPORT_TO_UNIT) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_TELEPORT_TO_UNIT 0 read invalid opcode");
            abort();
        }

        const std::vector<unsigned char> write_buffer = ::wow_world_messages::tbc::write_opcode(opcode);
    ...
    /* CMSG_CHAR_ENUM */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_CHAR_ENUM) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_CHAR_ENUM 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_CHAR_DELETE */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_CHAR_DELETE) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_CHAR_DELETE 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_PLAYER_LOGIN */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_PLAYER_LOGIN) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_PLAYER_LOGIN 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_LOGIN_SETTIMESPEED */ {
        ...
        const auto opcode = ::wow_world_messages::tbc::read_server_opcode(reader);
        if (opcode.is_none()) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_LOGIN_SETTIMESPEED 0 read invalid opcode");
            abort();
        }

        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_LOGIN_SETTIMESPEED) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_LOGIN_SETTIMESPEED 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_PLAYER_LOGOUT */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_PLAYER_LOGOUT) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_PLAYER_LOGOUT 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_LOGOUT_REQUEST */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_LOGOUT_REQUEST) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_LOGOUT_REQUEST 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_LOGOUT_RESPONSE */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_LOGOUT_RESPONSE) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_LOGOUT_RESPONSE 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_LOGOUT_COMPLETE */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_LOGOUT_COMPLETE) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_LOGOUT_COMPLETE 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_PET_NAME_QUERY */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_PET_NAME_QUERY) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_PET_NAME_QUERY 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_DESTROY_OBJECT */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_DESTROY_OBJECT) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_DESTROY_OBJECT 0 read invalid opcode");
            abort();
        }
    ...
    /* MSG_MOVE_TELEPORT_ACK_Client */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::MSG_MOVE_TELEPORT_ACK) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " MSG_MOVE_TELEPORT_ACK_Client 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_TUTORIAL_FLAGS */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_TUTORIAL_FLAGS) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_TUTORIAL_FLAGS 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_STANDSTATECHANGE */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_STANDSTATECHANGE) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_STANDSTATECHANGE 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_AUTOEQUIP_ITEM */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_AUTOEQUIP_ITEM) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_AUTOEQUIP_ITEM 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_INITIATE_TRADE */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_INITIATE_TRADE) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_INITIATE_TRADE 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_CANCEL_TRADE */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_CANCEL_TRADE) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_CANCEL_TRADE 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_INITIAL_SPELLS */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_INITIAL_SPELLS) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_INITIAL_SPELLS 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_CANCEL_CAST */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_CANCEL_CAST) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_CANCEL_CAST 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_SET_SELECTION */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_SET_SELECTION) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_SET_SELECTION 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_ATTACKSWING */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_ATTACKSWING) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_ATTACKSWING 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_ATTACKSTART */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_ATTACKSTART) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_ATTACKSTART 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_ATTACKSTOP */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_ATTACKSTOP) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_ATTACKSTOP 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_QUERY_TIME */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_QUERY_TIME) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_QUERY_TIME 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_PING */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_PING) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_PING 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_PONG */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_PONG) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_PONG 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_SETSHEATHED */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_SETSHEATHED) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_SETSHEATHED 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_AUTH_CHALLENGE */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_AUTH_CHALLENGE) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_AUTH_CHALLENGE 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_AUTH_SESSION */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_AUTH_SESSION) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_AUTH_SESSION 0 read invalid opcode");
            abort();
        }
        ...
        const auto opcode2 = ::wow_world_messages::tbc::read_client_opcode(reader2);
        if (opcode2.is_none()) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_AUTH_SESSION 0 read invalid second opcode");
            abort();
        }

        if (opcode2.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_AUTH_SESSION) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_AUTH_SESSION 0 read invalid second opcode");
            abort();
        }

        const std::vector<unsigned char> write_buffer2 = ::wow_world_messages::tbc::write_opcode(opcode2);
    ...
    /* SMSG_ACCOUNT_DATA_TIMES */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_ACCOUNT_DATA_TIMES) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_ACCOUNT_DATA_TIMES 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_REQUEST_ACCOUNT_DATA */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_REQUEST_ACCOUNT_DATA) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_REQUEST_ACCOUNT_DATA 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_UPDATE_ACCOUNT_DATA */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_UPDATE_ACCOUNT_DATA) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_UPDATE_ACCOUNT_DATA 0 read invalid opcode");
            abort();
        }
        ...
        if (opcode2.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_UPDATE_ACCOUNT_DATA) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_UPDATE_ACCOUNT_DATA 0 read invalid second opcode");
            abort();
        }
    ...
    /* CMSG_GMTICKET_GETTICKET */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_GMTICKET_GETTICKET) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_GMTICKET_GETTICKET 0 read invalid opcode");
            abort();
        }
    ...
    /* MSG_AUCTION_HELLO_Client */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::MSG_AUCTION_HELLO) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " MSG_AUCTION_HELLO_Client 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_SET_ACTIVE_MOVER */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_SET_ACTIVE_MOVER) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_SET_ACTIVE_MOVER 0 read invalid opcode");
            abort();
        }
    ...
    /* MSG_QUERY_NEXT_MAIL_TIME_Client */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::MSG_QUERY_NEXT_MAIL_TIME) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " MSG_QUERY_NEXT_MAIL_TIME_Client 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_MEETINGSTONE_INFO */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_MEETINGSTONE_INFO) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_MEETINGSTONE_INFO 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_CHAR_RENAME */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_CHAR_RENAME) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_CHAR_RENAME 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_REQUEST_RAID_INFO */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_REQUEST_RAID_INFO) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_REQUEST_RAID_INFO 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_MOVE_TIME_SKIPPED */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_MOVE_TIME_SKIPPED) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_MOVE_TIME_SKIPPED 0 read invalid opcode");
            abort();
        }
    ...
    /* CMSG_BATTLEFIELD_STATUS */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ClientOpcode::Opcode::CMSG_BATTLEFIELD_STATUS) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " CMSG_BATTLEFIELD_STATUS 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_SPLINE_SET_RUN_SPEED */ {
        ...
        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_SPLINE_SET_RUN_SPEED) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_SPLINE_SET_RUN_SPEED 0 read invalid opcode");
            abort();
        }
    ...
    /* SMSG_MOTD */ {
        ...
        const auto opcode = ::wow_world_messages::tbc::read_server_opcode(reader);
        if (opcode.is_none()) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_MOTD 0 read invalid opcode");
            abort();
        }

        if (opcode.opcode != ::wow_world_messages::tbc::ServerOpcode::Opcode::SMSG_MOTD) {
            printf(__FILE__ ":" STRINGIFY(__LINE__) " SMSG_MOTD 0 read invalid opcode");
            abort();
        }
