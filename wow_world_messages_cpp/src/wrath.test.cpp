...
int main() {
    /* CMSG_WORLD_TELEPORT */ {
        ...
        auto opcode = ::wow_world_messages::wrath::read_client_opcode(reader);
        ...
        const std::vector<unsigned char> write_buffer = ::wow_world_messages::wrath::write_opcode(opcode);
    ...
    /* SMSG_LOGOUT_RESPONSE */ {
        ...
        auto opcode = ::wow_world_messages::wrath::read_server_opcode(reader);
